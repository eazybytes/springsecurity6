...
DELETE FROM `authorities` WHERE name='VIEWACCOUNT';

UPDATE authorities SET name="ROLE_USER" WHERE name="VIEWACCOUNT";
UPDATE authorities SET name="ROLE_USER" WHERE name="VIEWBALANCE";
UPDATE authorities SET name="ROLE_USER" WHERE name="VIEWCARDS";
UPDATE authorities SET name="ROLE_ADMIN" WHERE name="VIEWLOANS";
